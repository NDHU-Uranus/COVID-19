...
par(mfrow = c(1, 3))
# k fold mse
plot(n.times_WHM.kfoldcv1[[1]],ylim = c(0.2,1.0),ylab="MSE",
...
# k fold RMSE
plot(n.times_WHM.kfoldcv1[[2]],ylim = c(0.4,1.0),ylab="RMSE",
...
# k fold MAE
plot(n.times_WHM.kfoldcv1[[3]],ylim = c(0.4,1.0),ylab="MAE",
