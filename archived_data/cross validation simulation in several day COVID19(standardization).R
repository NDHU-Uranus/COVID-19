...
par(mfrow = c(1, 3))
# k fold mse
plot(outcome_k_flods_WHM.cv[[1]], ylim = c(0,0.3),ylab="MSE",
     type = "b",col = "turquoise", pch = 20,main = "5 fold MSE")
...
# k fold RMSE
plot(outcome_k_flods_WHM.cv[[3]], ylim = c(0,0.3),ylab="RMSE",
     type = "b",col = "turquoise", pch = 20,main = "5 fold RMSE")
...
# k fold MAE
plot(outcome_k_flods_WHM.cv[[5]], ylim = c(0,0.3),ylab="MAE",
     type = "b",col = "turquoise", pch = 20,main = "5 fold MAE")
